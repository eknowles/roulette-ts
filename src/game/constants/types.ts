...
export const TYPES: {[typeId: string]: IType} = {
  ...
  T_STRAIGHT_UP: {id: 'T_STRAIGHT_UP', inside: true, maxBet: 25, payout: 35, name: 'Straight up', desc: 'Any single number'},
  T_ROW: {id: 'T_ROW', inside: true, payout: 17, name: 'Row', desc: '0, 00'},
  T_SPLIT: {id: 'T_SPLIT', inside: true, payout: 17, maxBet: 50, name: 'Split', desc: 'any two adjoining numbers vertical or horizontal'},
  T_STREET: {id: 'T_STREET', inside: true, payout: 11, maxBet: 75, name: 'Street', desc: 'any three numbers horizontal (1, 2, 3 or 4, 5, 6, etc.)'},
  T_CORNER: {id: 'T_CORNER', inside: true, payout: 8, maxBet: 100, name: 'Corner', desc: 'any four adjoining numbers in a block (1, 2, 4, 5 or 17, 18, 20, 21, etc.)'},
  T_BASKET: {id: 'T_BASKET', inside: true, payout: 6, name: 'Top line or Basket', desc: '0, 00, 1, 2, 3'},
  T_SIX_LINE: {id: 'T_SIX_LINE', inside: true, payout: 5, maxBet: 150, name: 'Six line', desc: 'any six numbers from two horizontal rows (1, 2, 3, 4, 5, 6 or 28, 29, 30, 31, 32, 33 etc.)'},
