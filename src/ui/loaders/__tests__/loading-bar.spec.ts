  ...
  describe("LoadingBar", () => {
    ...
    describe("calculatePercentage()", () => {
      it("should return a rounded string percentage value", () => {
        expect(LoadingBar.calculatePercentage(2, 4)).toBe(50);
        expect(LoadingBar.calculatePercentage(1.9999999, 4)).toBe(50);
      });
    });
    describe("showBar()", () => {
      it("should add the active classname to the bar element", () => {
        ...
        loading.showBar();
        expect(
          loading.bar.classList.contains(LoadingBar.CLASS_NAME_ACTIVE),
        ).toBe(true);
      });
    });
    describe("hideBar()", () => {
